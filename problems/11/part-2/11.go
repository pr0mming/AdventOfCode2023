...
const GALAXY_EXPANSION_PARAMMETER = (1000000 - 1) // Set how big is the expanded space
...
func getExpandedPaths(paths []bool, a, b int) int64 {
	var (
		rowsOffset    int64 = 0
		expandedPaths int64 = 0
	)
	...
	expandedPaths *= GALAXY_EXPANSION_PARAMMETER
